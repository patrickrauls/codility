...
describe('Number Of Disc Intersections', () => {
    ...
    describe('edge cases', () => {
        ...
        it('returns 3 given [1, 0, 1]', () => {
            expect(numberOfDiscIntersections([1, 0, 1])).to.equal(3);
        });
        ...
        it('returns 0, given [0, 0, 0, 0, 0]', () => {
            expect(numberOfDiscIntersections([0, 0, 0, 0, 0])).to.equal(0);
        });
        it('returns 0, given []', () => {
            expect(numberOfDiscIntersections([])).to.equal(0);
        });
    });
});